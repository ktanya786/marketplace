...
$get_tpl_sql = "SELECT *
                FROM `tbl_template` 
                WHERE tpl_id =" . $_SESSION['newly_added_tpl_id'];

$all_tpl_query = mysqli_query($sql, $get_tpl_sql);
$dataToShowMsg = "";
...
<form class="edit_template" action="manage_templates.php">
    <input type="hidden" value="<?php echo $_SESSION['newly_added_tpl_id']; ?>" id="t_id">
        ...
        <div class="container clear">
            ...
            <div class="temp-disc-right">
                <div class="template-disc-inr-left">
                    <div class="template-head edit-template-name">
                        <div class="edit-mode">
                    <i class="fas fa-pencil-alt"></i>
                        <input type="text" value="<?php echo $tpl_details['templatename']; ?>" class="template-name-edit" />
                        </div>
                        <p>by: <?php echo $row['createdby_userid']; ?></p>
                    </div>
                ...
                <div class="template-disc-inr-right">
                    <div class="download-btn disabled">
                        ...
                        <p class="no-downloads"><i class="fas fa-cloud-download-alt"></i> 0 downloads</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="template-left">
                <h3 class="header-page">System Screenshots</h2>
                    ...
                    <div class="description">
                        ...
                        <div class="temp-disc">
                            <i class="fas fa-pencil-alt"></i>
                            <textarea class="editable-temp-disc"><?php echo $tpl_details['description']; ?></textarea>
                        </div>
                    </div>
